...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    if (!isDeleting && currentText.length === fullSimba.length) {
      ...
      timeoutId = setTimeout(() => setIsDeleting(true), 5000); // Tunggu 7 detik
    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-[45%] bg-white flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="mb-6"> {/* Margin bottom dari page.tsx */}
            <div className="w-20 h-20 mx-auto bg-green-600 rounded-full flex items-center justify-center"> {/* Ukuran dari page.tsx */}
              <svg 
                className="w-12 h-12 text-white" /* Ukuran ikon dari page.tsx */
                fill="none" 
                stroke="currentColor" 
                viewBox="0 0 24 24"
              >
          ...
          <p className="text-center text-gray-600 mb-8 text-lg"> {/* Ukuran text-lg dari page.tsx */}
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-green-700 hover:bg-green-600 disabled:bg-gray-400 disabled:cursor-not-allowed text-white py-3.5 rounded-lg font-semibold text-base transition-all duration-300 mt-6 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >
              {isLoading ? (
                <>
