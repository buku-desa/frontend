  ...
  return (
    <div className={`bg-white rounded-lg shadow-md p-4 flex gap-4 items-start`}>
      ...
      <div className="w-24 h-24 bg-amber-100 rounded-md flex-shrink-0 flex items-center justify-center">
        <svg
          className="w-12 h-12 text-amber-600"   // lebih gelap supaya kontras
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
          aria-hidden="true"
      ...
      <div className="flex-1">
        ...
        <div className="flex items-center gap-2 mt-1 text-xs text-emerald-600">
          <svg className="w-3 h-3 text-emerald-700" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
