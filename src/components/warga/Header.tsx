...
export default function Header() {
  ...
  const navLinks = [
    ...
    { href: '/lembaran-desa', label: 'Lembaran Desa' },
    { href: '/berita-desa', label: 'Berita Desa' },
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 relative">
          <Link href="/" className="flex items-center gap-3">
            ...
            <span className="text-xl font-bold text-green-800">SIMBADES</span>
          </Link>
          ...
          <nav className="md:hidden pb-4 space-y-2">
            {navLinks.map((link) => (
              <Link
                ...
                className="block px-4 py-2 rounded text-gray-800 hover:bg-gray-100"
              >
                {link.label}
              </Link>
            ))}
